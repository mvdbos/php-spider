...
class ExternalRedirectFilterTest extends TestCase
{
    ...
    public function testRedirectToSameHost()
    {
        ...
        $resource = ResourceBuilder::create()
            ->withUri('http://example.com/page')
            ->withHeaders(['X-Guzzle-Redirect-History' => ['http://example.com/newpage']])
            ->withBody('content')
            ->build();
    ...
    public function testRedirectToExternalHost()
    {
        ...
        $resource = ResourceBuilder::create()
            ->withUri('http://example.com/page')
            ->withHeaders(['X-Guzzle-Redirect-History' => ['http://external.com/page']])
            ->withBody('content')
            ->build();
    ...
    public function testRedirectToSubdomainNotAllowed()
    {
        ...
        $resource = ResourceBuilder::create()
            ->withUri('http://example.com/page')
            ->withHeaders(['X-Guzzle-Redirect-History' => ['http://www.example.com/page']])
            ->withBody('content')
            ->build();
    ...
    public function testRedirectFromSubdomainToMainDomain()
    {
        ...
        $resource = ResourceBuilder::create()
            ...
            ->withHeaders(['X-Guzzle-Redirect-History' => ['http://example.com/page']])
            ->withBody('content')
            ->build();
    ...
    public function testExternalRedirectWithSubdomainsEnabled()
    {
        ...
        $resource = ResourceBuilder::create()
            ->withUri('http://example.com/page')
            ->withHeaders(['X-Guzzle-Redirect-History' => ['http://completely-different.org/page']])
            ->withBody('content')
            ->build();
    ...
    public function testRedirectToInvalidUrlWithNoHost()
    {
        ...
        $resource = ResourceBuilder::create()
            ->withUri('http://example.com/page')
            ->withHeaders(['X-Guzzle-Redirect-History' => ['/relative/path']])
            ->withBody('content')
            ->build();
    ...
    public function testLocalhostWithSubdomainsEnabled()
    {
        ...
        $resource = ResourceBuilder::create()
            ...
            ->withHeaders(['X-Guzzle-Redirect-History' => ['http://otherhost/page']])
            ->withBody('content')
            ->build();
    ...
    public function testSameLocalhostWithSubdomainsEnabled()
    {
        ...
        $resource = ResourceBuilder::create()
            ->withUri('http://localhost/page')
            ->withHeaders(['X-Guzzle-Redirect-History' => ['http://localhost/newpage']])
            ->withBody('content')
            ->build();
